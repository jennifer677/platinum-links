...
if (projectGrid && typeof PROJECTS !== "undefined") {
  PROJECTS.forEach(project => {
    ...
    card.innerHTML = `
      <button class="project-open" type="button" aria-label="View ${project.title}">
...
document.addEventListener("click", e => {
  ...
  const category = btn.querySelector("small").textContent;
  viewerImg.src = img.src;
  viewerImg.alt = title;
  viewerCaption.textContent = `${title} — ${category}`;
