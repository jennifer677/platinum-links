...
const SERVICES = [
  ...
  { icon: "gift", title: "Personalized", items: ["Gifts", "Memorial", "Custom Projects"] }
];

const PROJECTS = [
  {
    "image": "project-1.jpg",
    "title": "Rosemont Wolverines Tee",
    "category": "School Spirit Wear"
  },
  {
    "image": "project-2.jpg",
  ...
  {
    "image": "project-3.jpg",
    "title": "Kennedy Senior Shirt",
    "category": "Senior Night"
  },
  {
    "image": "project-4.jpg",
  ...
  {
    "image": "project-6.jpg",
    "title": "Sac State Redzz Tank",
    "category": "Custom Apparel"
  },
  {
    "image": "project-7.jpg",
    "title": "Inclusion Matters Shirts",
